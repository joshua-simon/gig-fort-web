...
const GigCard = ({
  ...
  const content = !isProfile ? (
    <div className="gigCardContainer">
      ...
      <div className="gigCard_imageAndBlurb">
        ...
        <div className="gigCard_imageAndBlurb_blurb">
          <p className="blurb">{`${blurb?.substring(0, 30)}...`}</p>
      ...
      <div style={{ marginTop: "3%" }}>
        <p style={{ fontFamily: "Lato", color: "#747474",fontSize:14 }}>{`${likes} ${
    ...
    <div className="gigCardContainer-profile">
      <div className="gigCard_header">
        <div className="gigCard_header_text">
          <p>
            {gigName?.length > 20 ? `${gigName?.substring(0, 19)}...` : gigName}
      ...
      <div className="gigCard_imageAndBlurb">
        ...
        <div className="gigCard_imageAndBlurb_blurb"></div>
      </div>
